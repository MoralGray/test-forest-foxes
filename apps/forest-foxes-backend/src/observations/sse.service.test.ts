...
describe('SseService', () => {
    it('emits event and stream receives it', () => new Promise<void>((done) => {
    ...
    it('supports processed event type', () => new Promise<void>((done) => {
        const service = new SseService();
    ...
    it('supports updated event type', () => new Promise<void>((done) => {
        const service = new SseService();
    ...
    it('supports deleted event type with id only', () => new Promise<void>((done) => {
        const service = new SseService();
    ...
    it('does not replay past events to late subscribers', () => new Promise<void>((done) => {
        const service = new SseService();
    ...
    it('supports data: null for created events', () => new Promise<void>((done) => {
        const service = new SseService();
